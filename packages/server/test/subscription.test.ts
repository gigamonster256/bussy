...
const TestLayer = Layer.mergeAll(DeviceService.Default, SubscriptionService.Default).pipe(
  ...
  describe("update", () => {
    ...
    it.effect("should fail when subscription not found", () =>
      Effect.gen(function* () {
        ...
        const result = yield* subs
          .update("sub_00000000000000000000000000", { notifyMinutes: 15 })
          .pipe(Effect.exit);
